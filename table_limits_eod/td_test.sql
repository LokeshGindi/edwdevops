...
or (schema_name='dwh_base' and TABLE_NAME='merchants' and content_group in ('std_data','std_data_int'))
or (schema_name='edwprod' and TABLE_NAME='deal_unity_map')
or (schema_name = 'dwh_base' and TABLE_NAME in ('city_deals_ext','appdomains','deal_run_option','deal_template_option','deal_template') and content_group = 'std_data')
